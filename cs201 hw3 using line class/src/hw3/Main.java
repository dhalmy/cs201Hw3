...
//			Customer dev = new Customer("Test", 123);
...
//			l1.addCustomer(dev);
		...
		public static ArrayList<Lane> addCustBestLine(ArrayList<Lane> l, Customer c) {
			int smallestLine = 0;
//			if(l.size() == 1) l.get(0).addCustomer(c);
//			if(l.size() == 2) {
//				if((l.get(0).getTotTime() < l.get(1).getTotTime()) ) {
//					l.get(0).addCustomer(c);
//				}
//				else l.get(1).addCustomer(c);
//			}
//			if(l.size() > 0) {
